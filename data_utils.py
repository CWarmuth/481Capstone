...
def load_trec50():
    ...
    with open(f'{ROOT_DIR}/data/trec/train.txt', 'r') as train_data:
        for line in train_data:
            overall_label = line.split(' ')[0].split(':')[0]
            train_label = line.split(' ')[0].split(':')[1]
            if train_label == "desc" and overall_label == "HUM":
                train_label = inv_label_dict['HUMdescription']
            elif train_label == 'other':
                if overall_label == 'LOC':
                    train_label = inv_label_dict['LOCother']
                elif overall_label == 'NUM':
                    train_label = inv_label_dict['NUMOther']
                else:
                    train_label = inv_label_dict[train_label]
            else:
                train_label = inv_label_dict[train_label]
    ...
    with open(f'{ROOT_DIR}/data/trec/test.txt', 'r') as test_data:
        for line in test_data:
            overall_label = line.split(' ')[0].split(':')[0]
            test_label = line.split(' ')[0].split(':')[1]
            if test_label == "description" and overall_label == "HUM":
                test_label = inv_label_dict['HUMdescription']
            elif test_label == 'other':
                if overall_label == 'LOC':
                    test_label = inv_label_dict['LOCother']
                elif overall_label == 'NUM':
                    test_label = inv_label_dict['NUMOther']
                else:
                    test_label = inv_label_dict[test_label]
            else:
                test_label = inv_label_dict[test_label]
